                        ...
                        >
                            ...
                            >
                                <img
                                    ...
                                    class="w-64 h-64 m-auto aspect-square 2xl:group-hover:w-24 group-hover:h-24 rounded-none group-hover:rounded-[50%] object-cover transition-all duration-300"
                                    onload={() => {
                                        if (i == 0) {

...
export type FundsResponse<Texpand = unknown> = Required<FundsRecord> &
    BaseSystemFields<Texpand>;
export type PortfolioCompaniesResponse<Texpand = unknown> =
    Required<PortfolioCompaniesRecord> & BaseSystemFields<Texpand>;
...
export type TypedPocketBase = PocketBase & {
    ...
    collection(
        idOrName: "portfolio_companies",
    ): RecordService<PortfolioCompaniesResponse>;

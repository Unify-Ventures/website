...
>
    ...
    <p class="text-justify">
        ...
        information contained in the website including but not limited to
        reports, tables, maps, diagrams and photographs. However, Unify will not
        be responsible for loss or damage arising from the use of this
        ...
        761GA of the Corporations Act 2001 (Cth).The information in this website
        is not intended to be relied upon as advice to investors or potential
        investors and has been prepared without taking into account personal
        investment objectives, financial circumstances or particular needs.
        Recipients of this information are advised to consult their own
        ...
        of which are beyond the control of Unify and their directors, employees,
        advisers or agents. Unify does not guarantee any particular rate of
        return or the performance, nor does Unify and its directors personally
        guarantee the repayment of capital or any particular tax treatment. Past
        performance is not indicative of future performance. All investments
        carry some level of risk, and there is typically a direct relationship
        between risk and return. We describe what steps we take to mitigate risk
        (where possible) in the investment documentation, which must be read
        prior to investing. It is important to note risk cannot be mitigated
        completely. Whilst the contents of this website is based on information
        from sources which CAR considers reliable, its accuracy and completeness
        cannot be guaranteed. Data is not necessarily audited or independently
        verified. Any opinions reflect Unify’s judgment at this date and are
        subject to change. Unify has no obligation to provide revised
        assessments in the event of changed circumstances. To the extent
        permitted by law, QUAY, Unify and their directors and employees do not
        accept any liability for the results of any actions taken or not taken
